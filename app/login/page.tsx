    ...
    <main className="min-h-screen bg-[#020202] text-zinc-100 selection:bg-[#7c3aed]/40 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-[400px] relative z-10">
        <div className="flex flex-col items-center mb-12">
          ...
          <h1 className="text-4xl font-black uppercase tracking-[-0.05em] italic">Ingresar</h1>
          <p className="text-zinc-500 text-sm font-bold uppercase tracking-widest mt-2">Acceso a la Bóveda</p>
        </div>
        ...
        <div className="bg-[#080808] border border-white/5 border-t-[#7c3aed] border-t-4 p-8 shadow-2xl">
          ...
          <div className="mt-8 pt-6 border-t border-white/5 text-center">
            <p className="text-zinc-500 text-xs font-bold uppercase tracking-widest">
              ¿No tenés cuenta?{" "}
              <Link href="/register" className="text-[#7c3aed] hover:underline underline-offset-4 ml-1">
                Registrate
              </Link>
            </p>
          </div>
